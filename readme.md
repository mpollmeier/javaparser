...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.24.3-SL3'
```
...
```
implementation 'com.github.javaparser:javaparser-core:3.24.3-SL3'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:3.24.3-SL3'
```
